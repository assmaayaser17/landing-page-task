    ...
    <div className="flex p-5 m-5 flex-col  ">
      ...
      <div class="title flex justify-center">
          ...
          لنجعل أحلامك التجارية حقيقية
						...
						<Image
							src={icon1}
							alt="Icon"
							class="absolute -top-2 -right-4 w-6 h-6"
						/>
					</div>
				</div>
      ...
      <div className= "flex flex-col items-center gap-7 ">
        ...
        <div className=" p-3  text-center">
          <p className="">
            نحن نقدم مجموعة شاملة من الخدمات التي تشمل تصميم المواقع
            <br/>
            ، تحسين تجربة المستخدم
            <br/>
            ، والتسويق الرقمي، مما يضمن لعملائنا الوصول إلى جمهور أوسع وزيادة مبيعاتهم.
          </p>
        </div>
  ...
  <div class="title flex justify-center">
					<div class="relative">
						<h2 class="text-2xl font-semibold mb-3">
							<span class="text-[#27989B]">انضم الي</span> مجتمع قمرة
						</h2>
						<Image
							src={icon1}
							alt="Icon"
